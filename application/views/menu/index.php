...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <!-- toggle add data -->
            <a href="" class="btn btn-primary mb-3 tampilModalTambah" data-toggle="modal" data-target="#newMenuModal">Add New Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['menu']; ?></td>
                            <td>
                                <a href="<?= base_url(''); ?>menu/ubah/<?= $sm['id']; ?>" class="badge badge-success tampilModalUbah" data-toggle="modal" data-target="#newMenuModal" data-id="<?= $sm['id']; ?>">Edit</a> |
                                <a href="<?= base_url(''); ?>menu/hapus/<?= $sm['id']; ?>" class="badge badge-danger tombol-hapus">Delete</a>
                            </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('menu'); ?>" method="post">
                    <!-- variable untuk menampung ID  menu -->
